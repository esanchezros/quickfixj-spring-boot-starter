...
public class QuickFixJClientActuatorAutoConfigurationTest {
	...
	private final ApplicationContextRunner contextRunner = new ApplicationContextRunner()
			.withConfiguration(AutoConfigurations.of(QuickFixJClientAutoConfiguration.class,
					QuickFixJClientActuatorAutoConfiguration.class));
	...
	public void shouldLoadActuatorEndpoint() {
		contextRunner.withPropertyValues("quickfixj.client.config=classpath:quickfixj-client.cfg")
				.withPropertyValues("quickfixj.client.enabled=true")
				.withPropertyValues("quickfixj.client.actuator.enabled=true")
