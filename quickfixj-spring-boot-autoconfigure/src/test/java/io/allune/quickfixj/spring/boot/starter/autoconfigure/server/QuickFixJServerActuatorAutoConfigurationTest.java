...
public class QuickFixJServerActuatorAutoConfigurationTest {
	...
	private final ApplicationContextRunner contextRunner = new ApplicationContextRunner()
			.withConfiguration(
					AutoConfigurations.of(QuickFixJServerAutoConfiguration.class, QuickFixJServerActuatorAutoConfiguration.class));
	...
	public void shouldLoadActuatorEndpoint() {
		contextRunner.withPropertyValues("quickfixj.server.config=classpath:quickfixj-server.cfg")
				.withPropertyValues("quickfixj.server.enabled=true")
				.withPropertyValues("quickfixj.server.actuator.enabled=true")
