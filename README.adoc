...
image:https://img.shields.io/badge/maven%20central-v{current-version}-blue.svg["Maven Central",link="https://search.maven.org/#search%7Cga%7C1%7Ca%3A%22quickfixj-spring-boot-starter%22"]
image:https://img.shields.io/hexpm/l/plug.svg["Apache 2",link="http://www.apache.org/licenses/LICENSE-2.0"]
image:https://img.shields.io/badge/quickfixj-3.0.1-blue.svg["QuickFIX/J 3.0.1", link="https://github.com/quickfix-j/quickfixj"]
...
It simplifies the configuration required to create and start an https://www.quickfixj.org/javadoc/3.0.1/quickfix/Initiator.html[Initiator] or https://www.quickfixj.org/javadoc/3.0.1/quickfix/Acceptor.html[Acceptor], and handles the lifecycle of the https://www.quickfixj.org/javadoc/3.0.1/quickfix/Connector.html[Connector].
