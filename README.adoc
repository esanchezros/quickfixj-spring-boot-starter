image:https://travis-ci.com/esanchezros/quickfixj-spring-boot-starter.svg?branch=main["Build Status", link="https://travis-ci.com/esanchezros/quickfixj-spring-boot-starter"]
