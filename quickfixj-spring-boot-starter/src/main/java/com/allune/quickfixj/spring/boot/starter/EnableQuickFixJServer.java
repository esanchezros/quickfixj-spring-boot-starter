package com.allune.quickfixj.spring.boot.starter;

import com.allune.quickfixj.spring.boot.starter.autoconfigure.server.QuickFixJServerMarkerConfiguration;
